  ...
  try {
    ...
    if (contentType.includes("text/html")) {
      ...
      if (targetUrl.includes("patents.google.com/patent")) {
        ...
        // Build custom HTML with image slider
        let customHtml = `
          <!DOCTYPE html>
          <html>
          <head>
            ...
            <style>
              ...
              .description.style-scope.patent-result,
              .claims.style-scope.patent-result {
                margin-bottom: 24px;
                font-size: 14px;
                color: #4d5156;
              }
              .citations.style-scope.patent-result {
                margin-bottom: 24px;
              }
              .citations.style-scope.patent-result ul {
                list-style: none;
                padding: 0;
              }
              .citations.style-scope.patent-result li {
                margin-bottom: 8px;
              }
          ...
          <body>
            <div class="style-scope patent-result">
              <h1 class="header style-scope patent-result">${title}</h1>
              <div class="layout horizontal">
                <div class="main-content">
                  <div class="abstract style-scope patent-result">
                    <h2>Abstract</h2>
                    <p>${abstract}</p>
                  </div>
                  ...
                  <div class="classifications style-scope patent-result">
                  ...
                  <div class="description style-scope patent-result">
                    <h2>Description</h2>
                    ${description}
                  </div>
                  <div class="claims style-scope patent-result">
                    <h2>Claims</h2>
                    ${claims}
                  </div>
                  <div class="citations style-scope patent-result">
                    <h2>Citations</h2>
                    <ul>${citations || '<li>No citations available.</li>'}</ul>
                  </div>
                </div>
                <div class="sidebar">
                  <div class="patent-header">${patentNumber}</div>
                  ...
                  <div class="metadata style-scope patent-result">
